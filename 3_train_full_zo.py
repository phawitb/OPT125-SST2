...
# ---------------- CONFIG ----------------
ZO = getattr(config, "ZO", {})
SEED          = ZO.get("SEED", getattr(config, "SEED", 42))
BATCH_SIZE    = ZO.get("BATCH_SIZE", getattr(config, "BATCH_SIZE", 32))
LR            = ZO.get("LEARNING_RATE", getattr(config, "LEARNING_RATE", 1e-4))
WEIGHT_DECAY  = ZO.get("WEIGHT_DECAY", getattr(config, "WEIGHT_DECAY", 0.0))
